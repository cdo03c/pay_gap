...
The following gender pay gap report explores the base pay for our `r nrow(data)` staff may receive by gender, seeking to expose any imbalance. We will use report results to assess;
